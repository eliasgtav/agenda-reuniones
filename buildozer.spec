...
android.permissions = INTERNET,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,RECORD_AUDIO,READ_CONTACTS,VIBRATE,RECEIVE_BOOT_COMPLETED,POST_NOTIFICATIONS,CAMERA,READ_PHONE_STATE,READ_CALL_LOG,SEND_SMS
android.api = 34
android.minapi = 26
android.ndk = 25b
android.sdk = 35
